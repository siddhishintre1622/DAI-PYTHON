...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS subjects (sub_id INTEGER PRIMARY KEY,
    sub_name TEXT)''')
cursor.execute('''
    CREATE TABLE IF NOT EXISTS students (student_id INTEGER PRIMARY KEY, stud_name TEXT
    subject_id TEXT, marks INTEGER
